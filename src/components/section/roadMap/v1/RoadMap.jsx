...
import roadMapBgGrand from "../../../../assets/images/bg/riph_roadmap_mash_Grad.png";
    ...
    <RoadMapStyleWrapper id="roadmap">
      <div className="container">
        ...
        {/*<div className="v1_roadmap_divider">
          <img src={dividerImgShape} alt="riph nft section divider" />
  </div>*/}
                ...
                <SliderItem key={i}>
                  <div className="v1_roadmap_contents_text">
                    <div className="roadmap_step">
                      <h3> {item.title} </h3>{" "}
                      <img src={item.icon} alt="riph road map icon" />
                    </div>
                    <h4>{item.subtitle}</h4>
                    <p>{item.text}</p>
                  </div>
      ...
      <div className="riph_roadmap_mass_gard">
        <img src={roadMapBgGrand} alt="riph nft road map bg" />
      </div>
    </RoadMapStyleWrapper>
  );
};
